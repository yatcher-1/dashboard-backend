...
<li><a class="dropdown-item" href="{{route('super_admin.profile')}}"><i class="bx bx-user"></i><span>Profile</span></a>
</li>
@elseif(auth()->user()->role == "admin")
<li><a class="dropdown-item" href="{{route('admin.profile')}}"><i class="bx bx-user"></i><span>Profile</span></a>
</li>
@elseif(auth()->user()->role == "staff")
<li><a class="dropdown-item" href="{{route('staff.profile')}}"><i class="bx bx-user"></i><span>Profile</span></a>
</li>
@endif
<li><a class="dropdown-item" href="/"><i class="bx bx-cog"></i><span>Change Password</span></a>
</li>
