...
<div class="row">
<div class="col-lg-8">
    <form method="post" action="{{route('subparty.store')}}">
        @csrf
<div class="card">
<div class="card-body">
<div class="row mb-3">
...
<option value="{{$party_item->party_name}}">{{$party_item->party_name}}
...
<div class="col-sm-9 text-secondary">
    <input type="text" name="subparty_name" class="form-control" value=""/>
    @error('subparty_name')
...
<div class="col-sm-9 text-secondary">
<input type="submit" class="btn btn-primary px-4" value="Add Sub-Firm"/>
</div>
</div>
</div>
</div>
