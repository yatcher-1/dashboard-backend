...
<div class="breadcrumb-title pe-3">Add Return Scan Data</div>
<div class="ps-3">
<nav aria-label="breadcrumb">
<ol class="breadcrumb mb-0 p-0">
<li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
</li>
<li class="breadcrumb-item active" aria-current="page">Add Return Scan Data</li>
</ol>
</nav>
</div>
...
<input class="form-control" name="returnscan" type="file" id="image">
</div>
