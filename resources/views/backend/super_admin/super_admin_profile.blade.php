@extends('backend/super_admin/super_admin_master')
@section('super_admin')
...
<span class="text-secondary">https://rklearss.com</span>
</li>
<li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
...
<span class="text-secondary">rklearnsss</span>
</li>
</ul>
</div>
</div>
...
<div class="mb-3">
<img id="showImage" src="{{!empty($adminData->profile_photo_path)?url('upload/admin_images/'.$adminData->profile_photo_path):url('upload/no_image.jpg')}}" alt="Admin" width="100px" height="100px"/>
</div>
